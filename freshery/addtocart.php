...
<div class="d-flex align-items-center mb-5">
                  ...
                  <div class="flex-grow-1 ms-3">
                    ...
                    <h5 class="text-primary">ONIAN</h5>
                    <h6 style="color: #9e9e9e;">fresh & organic</h6>
                    <div class="d-flex align-items-center">
                      <p class="fw-bold mb-0 me-5 pe-3">30/kg</p>
                ...
                <div class="d-flex align-items-center mb-5">
                  ...
                  <div class="flex-grow-1 ms-3">
                    <a href="#!" class="float-end text-black"><i class="fas fa-times"></i></a>
                    <h5 class="text-primary">TOMATO</h5>
                    <h6 style="color: #9e9e9e;">fresh & organic</h6>
                    <div class="d-flex align-items-center">
                      <p class="fw-bold mb-0 me-5 pe-3">24/kg</p>
                      <div class="def-number-input number-input safari_only">
                        <button onclick="this.parentNode.querySelector('input[type=number]').stepDown()"
                          class="minus"></button>
                        <input class="quantity fw-bold text-black" min="0" name="quantity" value="1"
                ...
                <div class="d-flex align-items-center mb-5">
                  ...
                  <div class="flex-grow-1 ms-3">
                    <a href="#!" class="float-end text-black"><i class="fas fa-times"></i></a>
                    <h5 class="text-primary">POTATO</h5>
                    <h6 style="color: #9e9e9e;">fresh & organic</h6>
                    <div class="d-flex align-items-center">
                      <p class="fw-bold mb-0 me-5 pe-3">50/kg</p>
                      <div class="def-number-input number-input safari_only">
                        <button onclick="this.parentNode.querySelector('input[type=number]').stepDown()"
                          class="minus"></button>
...
<hr class="mb-4" style="height: 2px; background-color: #1266f1; opacity: 1;">
              ...
              <div class="col-lg-6 px-5 py-4">
                ...
                <form class="mb-5">
                  ...
                  <p class="mb-5">The company itself is a very successful company <a
                      href="#!">blinded by wisdom</a>.</p>

                  <button type="button" class="btn btn-primary btn-block btn-lg">Pay now</button>

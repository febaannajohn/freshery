                ...
                <div class="item">
                    <div class="card rounded-0 border-0 text-center">
                        ...
                        <div class="card-img-overlay d-flex align-items-center justify-content-center">
                            ...
                            <a href="category.php?cat=Vegetable" class="btn btn-primary btn-lg">Vegetables</a>
                        </div>
                    </div>
                </div>
                <div class="item">
                    <div class="card rounded-0 border-0 text-center">
                        ...
                        <div class="card-img-overlay d-flex align-items-center justify-content-center">
                            ...
                            <a href="category.php?cat=Fruit" class="btn btn-primary btn-lg">Fruits</a>
                        </div>
                    </div>
                </div>
                <div class="item">
                    <div class="card rounded-0 border-0 text-center">
                        ...
                        <div class="card-img-overlay d-flex align-items-center justify-content-center">
                            ...
                            <a href="category.php?cat=Meat" class="btn btn-primary btn-lg">Meats</a>
                        </div>
                    </div>
                </div>
                <div class="item">
                    <div class="card rounded-0 border-0 text-center">
                        ...
                        <div class="card-img-overlay d-flex align-items-center justify-content-center">
                            ...
                            <a href="category.php?cat=Fish" class="btn btn-primary btn-lg">Fishes</a>
                        </div>
                    </div>
                </div>
